  ...
  <body>
    ...
    <section class="container home-feature mb-5">
      <div class="row">
        ...
        <div class="col-md-4 p-0 two-col element-animate">
          <div class="col-inner p-xl-5 p-lg-5 p-md-4 p-sm-4 p-4">
            <h2>Mission</h2>
            <p>Brindavan Hospital comprises of a dedicated team of specialized doctors, nurses, & paramedical professionals. Our medical technologies & high quality treatments provide preventive and curative healthcare solutions.</p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 border-right element-animate">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span>01</span> Infrastructure</a>
    ...
    <section class="section stretch-section">
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 text-center element-animate">
              <img src="img/hospital.jpg" class="img-fluid mb-4" alt="Image placeholder">
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-5 text-center element-animate">
              <h2 class="text-uppercase mb-4">Hospital History</h2>
              <p class="lead">Brindavan hospital, a state of the art multispecialty hospital situated at 3rd cross Kalidasa Road, Jayalakshmipuram,Mysore </p>
              <p class="mb-5">The Hospital harbours advanced medical equipment, excellent ambience and modren facilities, architecturally designed for maximum patient comfort and convenince.Our motto is to provide technically superior and cost effective healthcare service to the people of Mysore and surrounding.</p>
          </div>
        </div>
        </div>
    </section>
      ...
      <div class="container">
        <div class="row text-center justify-content-center">
          <div class="col-md-10">
            ...
            <p class="element-animate"><a href="services.php" class="btn btn-primary btn-lg">Get In Touch</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row element-animate">
          ...
          <div class="col-md-4">
            ...
            <h4 class="text-uppercase mb-3 h6 text-white">Email</h5>
              <p class="mb-5"><a href="mailto:info@brindavanhospital.com">info@brindavanhospital.com</a></p>
          ...
          <div class="col-md-3 ">
            ...
            <p class="mb-5">No.64/1, Kalidasa Road, <br/>3rd Cross, Jayalakshmipuram,<br/>Mysore- 570012</p>
        ...
        <div class="row element-animate">
            ...
            <div class="col-md-6 col-sm-12 copyright">
              <p>&copy; 2018 name &amp; Developed by <a href="#">name</a></p>
            </div>
